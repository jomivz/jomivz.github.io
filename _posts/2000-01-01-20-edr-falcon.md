...
* [events-logscale](#events-logscale)
	...
	* [logscale-net](#logscale-net)
		...
		* [net-dns-req](#net-dns-req)
		* [net-dns-req-win](#net-dns-req-win)
...
#### <a name='net-conns-process'></a>net-conns-process
```
...
#### <a name='net-dns-req-win'></a>net-dns-req-win
...
### <a name='jq-over-detections-by-machine-export'></a>jq-over-detections-by-machine-export
```
# get IOC DOMAINS
...
### <a name='jq-over-detections-by-user-export'></a>jq-over-detections-by-user-export
```
